            ...
            child: Container(
              ...
              child: Stack(
                children: [
                 Positioned(
  top: 10,
  left: -10,  // Keep this consistent
  child: SizedBox(
    width: 250,  // Set a fixed width
    height: 250,  // Set a fixed height
    child: Image.asset(
      _plantList[widget.plantId].imageURL,
      fit: BoxFit.cover,  // You can also use BoxFit.contain based on your needs
    ),
  ),
),
          ...
          //bottom container with details and add to cart button and favorite button
          Positioned(
            bottom: 0,
            left: 0,
            right: 0,
