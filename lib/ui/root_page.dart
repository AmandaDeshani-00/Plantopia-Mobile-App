...
import 'package:plantopia/constants.dart';
import 'package:plantopia/models/plants.dart';
import 'package:plantopia/ui/scan_page.dart';
import 'package:plantopia/ui/screens/cart_page.dart';
import 'package:plantopia/ui/screens/favourite_page.dart';
      ...
      bottomNavigationBar: AnimatedBottomNavigationBar(
        ...
        onTap: (index){
          setState(() {
            ...
            myCart = addedToCartPlants.toSet().toList(); //remove duplicates from the list [toSet()] and convert it to a list [toList()]
          });
        }
      ),
    );
